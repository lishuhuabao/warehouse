...
#define __LED_PC_TXD_PIN                      GPIO_PIN_0//这个是Lora发送指令时，led亮灯控制管脚
...
#define __LED_PC_RXD_PIN                      GPIO_PIN_1//这个是Lora发送指令时，led亮灯控制管脚
...
#define __LED_WIFI_TXD_PIN                    GPIO_PIN_12//这个是Lora接收指令时，led亮灯控制管脚
...
#define __LED_WIFI_RXD_PIN                    GPIO_PIN_11//这个是Lora接收指令时，led亮灯控制管脚
...
**
*/
static void __LedPcTxdOutLow(void)//Lora发送指令——提示灯
{
	__LED_PC_TXD_(1);
}
...
**
*/
static void __LedWifiTxdOutLow(void)//Lora接收指令——提示灯
{
	__LED_WIFI_TXD_(1);
}
...
static void __LedPcTxdOutHigh(void)//Lora发送指令——提示灯
{
	__LED_PC_TXD_(0);
}
...
**
*/
static void __LedWifiTxdOutHigh(void)//Lora接收指令——提示灯
{
	__LED_WIFI_TXD_(0);
}
