...
const unsigned char ESP12F_ssid[] = "8#301B";//"ZB_IOT";										// 此处填写无线AP名称
const unsigned char ESP12F_password[] = "q237219575";//"ZB_IOT666";								// 此处填写无线AP密码
const unsigned char ESP12F_ip[] = "192.168.2.106";//"192.168.1.48";									// 此处填写服务器IP地址
