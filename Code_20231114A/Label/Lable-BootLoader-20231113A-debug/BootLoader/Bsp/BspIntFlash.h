...
@Flash User:
	...
	-size		    0x 2000	 //8K		 
***************************************************************************/
#define	__DATA_RECORD_START_ADDR   0x0801E000   //0x0801E000
#define	__DATA_RECORD_END_ADDR     0x08020000    //0x08020000
...
#define FLASH_UPDATE_FLAG_START_ADDR  ADDR_FLASH_PAGE_(60) //60 15k 76 19k
#define FLASH_UPDATE_FLAG_END_ADDR    ADDR_FLASH_PAGE_(64) //64 16k 80 20k
#define FLASH_UPDATE_FLAG_SIZE        (FLASH_UPDATE_FLAG_END_ADDR - FLASH_UPDATE_FLAG_START_ADDR) // 1K

#define FLASH_APP_START_ADDR          ADDR_FLASH_PAGE_(64) //64 16k 80 20k
#define FLASH_APP_END_ADDR            ADDR_FLASH_PAGE_(272) //272 68k 288 72k
#define FLASH_APP_SIZE                (FLASH_APP_END_ADDR - FLASH_APP_START_ADDR) //52K

#define	FLASH_BACKUP_START_ADDR       ADDR_FLASH_PAGE_(272) // 272 68K 288 72k
#define	FLASH_BACKUP_END_ADDR         ADDR_FLASH_PAGE_(480) //480 120K 496 124k
