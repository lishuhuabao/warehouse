...
**
*/ 
#define SYSTEM_CLOCK  32000000 //系统主频 32MHz
#define SIM_BAUD      460800   //模拟UART 波特率 460800

#if    32000000 == SYSTEM_CLOCK
	#if 460800 == SIM_BAUD
		#define SIM_BUAD_START_DELAY 		8
		#define SIM_BUAD_DATA_DELAY			8
		#define SIM_BUAD_STOP_DELAY			8
	#endif
#endif
...
{
	__SIM_TXD_PORT->BSRR = (u32)__SIM_TXD_PIN << 16;
}
